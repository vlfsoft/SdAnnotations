 ...
 * The generic term callable unit is sometimes used.[1]
 */
...
public @interface FunctionPrinciple {
     ...
     * a function or expression is said to have a side effect if it modifies some state outside its scope or has an observable interaction with its calling functions or
     ...
     * The reason why side effects are bad is because if you had them, a function can give unpredictable results depending on the state of the system;
     ...
     *  An expression is said to be referentially transparent if it can be replaced with its corresponding value without changing the program's behavior.[1]
     ...
     * higher-order function (also functional, functional form or functor) is a function that does at least one of the following:<ul>
